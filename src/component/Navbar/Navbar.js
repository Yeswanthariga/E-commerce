      ...
      <div className="navbar-item">
        ...
        >
          <ul className="navbar-item-left">
            <Link to="/home">
              {" "}
              <li className="list-item-left">Home</li>
            </Link>
            <Link to="/shop">
              {" "}
              <li className="list-item-left">Shop</li>
            </Link>
            <Link to="/about">
              {" "}
              <li className="list-item-left">About</li>
            </Link>
            <Link to="/blog">
              {" "}
              <li className="list-item-left">Blog</li>
            </Link>
            <Link to="/contact">
              {" "}
              <li className="list-item-left">Contact</li>
            </Link>
            <Link to="/pages">
              {" "}
              <li className="list-item-left">Pages</li>
            </Link>
          </ul>
        </div>
